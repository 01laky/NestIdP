...
| `sso-flow.mmd`            | SP-initiated SSO sequence (v0.6 login API; v0.7 SAML POST)       | [proposal.MD](../proposal.MD) §6.2, [development.md](../development.md) |
...
| `evergreen-ui.mmd`        | Evergreen tokens, `src/ui`, admin/login pages, self-hosted fonts | [development.md](../development.md) § Evergreen UI                      |
