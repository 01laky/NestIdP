...
| `database-providers.mmd`       | Encrypted libSQL adapter + startup migration workflow          | [database.md](../database.md)                                                                                       |
...
| `external-identity-db.mmd`     | External identity DB: store hot-swap, relocate vs mirror       | [database.md](../database.md)                                                                                       |
