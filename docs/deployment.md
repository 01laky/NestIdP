...
| `SP_METADATA_FETCH_TIMEOUT_MS`                       | `5000`                      | Timeout for the SP form's "fetch metadata from URL" import; bounded `[1000, 60000]`                                                                                                                                                                                                                                                            |
| `SP_METADATA_FETCH_MAX_BYTES`                        | `262144`                    | Response size cap for fetched SP metadata; bounded `[1024, 5242880]`                                                                                                                                                                                                                                                                           |
| `SP_METADATA_FETCH_MAX_REDIRECTS`                    | `3`                         | Max redirects followed when fetching SP metadata by URL; bounded `[0, 10]`                                                                                                                                                                                                                                                                     |
