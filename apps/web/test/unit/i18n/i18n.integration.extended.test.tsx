...
import { changeLocale, initI18n } from '@/i18n/i18n';
import { renderWithUi } from '@test/helpers/renderWithUi';
import { useAdminDocumentTitle } from '@/i18n/useAdminDocumentTitle';
import { webRoot } from '@test/helpers/paths';
...
describe('i18n integration — extended (WEB-I18N-99–115)', () => {
	...
	it('WEB-I18N-101: changeLocale es updates common.save label', async () => {
		...
		const { resolveI18nKey } = await import('@/i18n/api-error-messages');
	...
	it('WEB-I18N-110: formatDateTime after locale switch', async () => {
		const { formatDateTime } = await import('@/i18n/i18n');
		await initI18n('cs');
	...
	it('WEB-I18N-113: sequential changeLocale through nine non-en locales', async () => {
		...
		const { getI18n } = await import('@/i18n/i18n');
	...
	it('WEB-I18N-115: I18nProvider exports initI18nForTests for vitest', async () => {
		const mod = await import('@/i18n/I18nProvider');
