...
import { changeLocale, getI18n, initI18n } from '@/i18n/i18n';
...
describe('i18n integration (WEB-I18N-09–40)', () => {
	...
	it('WEB-I18N-20: document title Czech', async () => {
		await initI18n('cs');
		const { useAdminDocumentTitle } = await import('@/i18n/useAdminDocumentTitle');
		function Probe() {
	...
	it('WEB-I18N-33: audit category sync French', async () => {
		await initI18n('fr');
		const { auditCategoryLabel } = await import('@/i18n/enum-labels');
