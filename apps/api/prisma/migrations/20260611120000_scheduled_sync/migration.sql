-- AlterTable
ALTER TABLE "SyncLog" ADD COLUMN "triggerSource" TEXT;
...
INSERT INTO "new_ApiConnection" ("apiContractConfig", "authCredentialsEncrypted", "authType", "baseUrl", "createdAt", "id", "isLocalDirectory", "lastSyncAt", "lastSyncStatus", "name", "oauthAudience", "oauthClientAuthMethod", "oauthClientId", "oauthClientSecretEncrypted", "oauthScope", "oauthTokenRequestParams", "oauthTokenUrl", "updatedAt") SELECT "apiContractConfig", "authCredentialsEncrypted", "authType", "baseUrl", "createdAt", "id", "isLocalDirectory", "lastSyncAt", "lastSyncStatus", "name", "oauthAudience", "oauthClientAuthMethod", "oauthClientId", "oauthClientSecretEncrypted", "oauthScope", "oauthTokenRequestParams", "oauthTokenUrl", "updatedAt" FROM "ApiConnection";
